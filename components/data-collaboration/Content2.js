  ...
  return (
    ...
    >
      <div
        ...
        max-w-[1400px] md:px-8 md:py-8  lg:py-2 lg:px-8  mx-auto md:overflow-hidden xl:overflow-visible"
      >
        <div className="col-span-2 order-last md:order-first px-10 md:px-0 lg:pr-20">
          {isTitleCol ? (
            <div className="my-5">
              <h3 className="text-sm-medium md:text-lg-medium my-5 text-athinia-green">
                {title}
              </h3>
          ...
          <ul className={`list-disc ${isTitleCol && "ml-10"} ml-10`}>
            {allList.map((item) => (
              <li className="text-sm-small md:text-[16px] font-[100]	 ">{item}</li>
            ))}
          </ul>
        ...
        <div className="col-span-1">
          {!isTitleCol ? (
            <div className="text-athinia-green p-10   pb-10 md:p-0">
              <>
