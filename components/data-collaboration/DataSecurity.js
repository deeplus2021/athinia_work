  ...
  return (
    ...
    >
      <div
        ...
        max-w-[1400px] 
        mx-auto md:px-8  p-[6%_0%_6%_0%] md:px-5"
      >
        <div className="col-span-4 px-5 md:px-8 lg:px-0">
          <h3 className="text-athinia-green text-lg-medium md:text-lg-large mb-3">
            Data Security
          </h3>
          <h3 className="text-white text-[1.2em] font-medium md:text-lg-small lg:text-lg-medium mb-3">
