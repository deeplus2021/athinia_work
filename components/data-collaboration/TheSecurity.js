    ...
    >
      ...
      <div
        ...
        className="md:min-h-auto max-w-[1400px] p-8  mx-auto
             items-center py-20 lg:pt-0 lg:pb-[8rem]"
      >
        <h1
          className="text-lg-medium  md:text-[3.5em] lg:text-lg-large tracking-[-1px] 

                              text-left text-athinia-green mb-[20px] md:pr-20 md:mr-20 lg:mr-0"
        >
        ...
        <h3
          ...
          className="text-[1.2em] font-medium  md:text-sm-small lg:text-lg-medium 
                              ...
                              text-left text-white mb-[20px] md:pr-20 md:mr-20 lg:mr-0"
        >
        ...
        <Link
          ...
          className="text-white text-sm-medium md:text-lg-medium text-athinia-green underline decoration-athinia-green"
        >
