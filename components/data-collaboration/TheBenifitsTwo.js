  ...
  return (
    <section
      className=" w-full bg-athinia-dark flex-initial h-auto
              break-words pb-[8rem] lg:pb-[10rem] bg-[length:50vw_auto] lg:pt-5"
     
    >
      <div className="max-w-[1400px] 
            mx-auto  text-white pb-10 px-[30px] md:px-8 lg:px-[1.7rem] ">
        <h3 className=" text-lg-medium md:text-lg-large mb-3 letter-spacing--1">Benefits</h3>
      ...
      >
        ...
        <div className="px-[30px] md:px-2 lg:px-[1.5rem] py-5 md:py-0">
          <Image
