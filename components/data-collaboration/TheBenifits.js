  ...
  return (
    <section
      className="w-full flex-initial h-auto
              break-words  pt-3 md:pt-[1.5rem] lg:pt-[4.5rem] lg:pb-[5rem]"
    >
      <div class="flex items-center my-10">
        ...
        <h1
          class="text-sm-medium
                              text-left text-athinia-purple px-4 md:px-3"
        >
      ...
      <div className="lg:min-h-[100vh] max-w-[1400px] p-8 mx-auto items-center px-8 md:pt-5 lg:pt-8 lg:px-[10px] lg:pt-0">
        ...
        >
          <div
            className=" mt-[3.5rem] md:mt-0 col-span-5 md:col-span-3 bg-before-after-mobile md:bg-before-after-image bg-contain bg-center bg-no-repeat 
                              h-[335px] w-[335px] mr-0 md:h-[450px] md:w-[450px]  lg:h-[730px] lg:w-[810px] lg:min-h-[550px]"
          ></div>

          <div className="col-span-5 md:col-span-2 mt-4 md:mt-0 md:ml-10 lg:ml-0 px-0 xl:pl-20 lg:mb-20 relative">
            <motion.div
              ref={textRef}
              style={{ y: width < 1024 ? "" : yPosAnimText }}
            >
              <div className="flex my-2 md:my-5 md:mt-8 lg:mt-1">
                <div className="pt-1 md:pt-0 lg:pt-1">
                  <FaCircle size={20} fill="#5F82FF" />
                </div>
                <div>
                  <p className=" md:text-[18px] lg:text-[100%] px-2 ml-1 md:ml-0">
                    {" "}
              ...
              <div className="flex my-5">
                ...
                <div>
                  <p className="px-2  md:text-[18px] lg:text-[100%] ml-1 md:ml-0">
                    {" "}
        ...
        <div class="mt-3 md:mt-0 lg:mx-5 lg:px-4 xl:mx-0  grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-16 lg:gap-10 md:mb-5 lg:mb-0">
          <div>
            <h3
              className="text-sm-medium md:text-lg-medium md:tracking-[-1px] 
                              text-left text-athinia-purple  "
            ...
            <p className="mt-[0.6rem] md:mt-0 lg:mt-2">
            ...
            <CustomButton
              ...
              paddingY={"py-[0.9rem] md:py-3 lg:py-[0.85rem]"}
              wrapperClass={"my-4 md:my-5 text-center lg:text-left tracking-[1px] md:tracking-[0px] lg:tracking-[1px]"}
              link={"/data-collaboration/device-makers/"}
              text={"EXPLORE BENEFITS FOR DEVICE MAKERS"}
            />
          </div>

          <div className="md:mr-3 lg:mr-0 mt-4 md:mt-0">
            <h3
              className="text-sm-medium md:text-lg-medium md:tracking-[-1px] 
                              text-left text-athinia-purple "
            >
