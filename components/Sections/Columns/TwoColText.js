    ...
    >
      ...
      >
        <div className="flex-initial lg:w-[60%] md:pb-8 lg:pb-0">
          <h3 className="text-sm-large md:text-lg-large mr-0 md:mr-10">Athinia offers a faster path to success.</h3>
        </div>

        <div className="flex-initial lg:w-[40%] mt-[4rem] md:mt-2">
