        ...
        <div
          className="grid grid-cols-1 
                ...
                min-h-[76vh] md:min-h-[42vh] max-w-[1020px] lg:p-8
                 items-center relative mx-auto lg:px-0 py-0 md:py-20 lg:py-[3rem]"
        >
          <div className="flex flex-col md:flex-row ">
            <div className="px-3 pb-10 md:py-0 md:w-[100%]">
              <Image alt="david-anderson" width={180} height={180} src={'/images/david_anderson.jpg'} className="h-[180px] w-[180px] md:h-[200px] md:w-[200px] xl:h-[200px] xl:w-[200px] ml-auto mr-auto  rounded-full"/>
        
            </div>
            <div className="px-3 pt-4 md:pt-0 md:px-[2.5em] lg:px-3">
              <div className="text-athinia-dark">
                <h3  className="font-extralight text-sm-medium md:text-sm-large font-weight-0 sm:line-height-13 md:line-height-16 font-size-14">
