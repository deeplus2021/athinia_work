    ...
    <>
      <section
        className="w-full flex-initial h-auto
            ...
            break-words bg-athinia-purple p-[2em] md:px-[0.5em] md:py-[6%] lg:py-[4em]   "
      >
        <div
        ...
        >
          <h4 className="text-white text-center text-sm-medium md:text-lg-medium mt-3 lg:mt-5 text-key-benefits">
          ...
          <section className="text-center">
            <div className="grid grid-cols-5 gap-3 pt-2 lg:pt-0 lg:mt-0 px-0">
              <div className="content-between grid col-span-5 md:col-span-2 ">
                <p className="text-white md:text-[112%] lg:text-[100%] x text-center  lg:px-10 pb-0 md:pb-5">
             ...
             <motion.small ref={svgRefGreen} style={{rotate:yPosAnimGreen}} className="block lg:mt-10" transition={{ duration: 80 }}>
             <Image
